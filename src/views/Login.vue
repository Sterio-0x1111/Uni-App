      ...
      <ion-card>
        ...
        <ion-card-content>
          ...
          <ion-item>
            ...
            <ion-input v-model="username" type="text" id="username" color="primary" required></ion-input>
          </ion-item>

          <ion-item>
            <ion-label position="stacked" color="primary">Password</ion-label>
            <ion-input v-model="password" type="password" id="password" color="primary" required></ion-input>
          </ion-item>
